...
public class Token
{
    ...
    // debug flags
    public static readonly bool  printTrees = false;
    static readonly bool  printICode = false;
    static readonly bool  printNames = printTrees || printICode;

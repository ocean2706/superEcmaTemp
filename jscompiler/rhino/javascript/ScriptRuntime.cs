...
//         // static readonly long serialVersionUID = -5891740962154902286L;
//
//          //@Override
//          public Object call(Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
//            throw new typeError0("msg.op.not.allowed");
//          }
//          //@Override
...
//          }  
    ...
    static class NoSuchMethodShim : Callable {
        String methodName;
                           ...
                           Object[] args)
        {
           ...
           // nestedArgs[1] = new ArrayLiteral(args, null, cx, scope);
  ...
  //  public virtual  static Type
	public static Type    BooleanClass      = Kit.classOrNull("java.lang.bool "),
	public static Type   ByteClass         = Kit.classOrNull("java.lang.Byte"),
	public static Type  CharacterClass    = Kit.classOrNull("java.lang.Character"),
	public static Type  ClassClass        = Kit.classOrNull("java.lang.Class"),
	public static Type  DoubleClass       = Kit.classOrNull("java.lang.Double"),
	public static Type  public static Type  FloatClass        = Kit.classOrNull("java.lang.Float"),
	public static Type  IntegerClass      = Kit.classOrNull("java.lang.Integer"),
	public static Type  LongClass         = Kit.classOrNull("java.lang.Long"),
	public static Type  NumberClass       = Kit.classOrNull("java.lang.Number"),
	public static Type  ObjectClass       = Kit.classOrNull("java.lang.Object"),
	public static Type  ShortClass        = Kit.classOrNull("java.lang.Short"),
	public static Type  StringClass       = Kit.classOrNull("java.lang.String"),
	public static Type  DateClass         = Kit.classOrNull("java.util.Date");

	public static Type ContextClass = Kit.classOrNull("org.mozilla.javascript.Context"),
	public static Type  ContextFactoryClass            = Kit.classOrNull("org.mozilla.javascript.ContextFactory"),
	public static Type  FunctionClass            = Kit.classOrNull("org.mozilla.javascript.Function"),
	public static Type  ScriptableObjectClass            = Kit.classOrNull("org.mozilla.javascript.ScriptableObject");
	public static Type <Scriptable> ScriptableClass = typeof(Scriptable);
        //Scriptable.class;
    ...
    public static bool  isRhinoRuntimeType(Class<?> cl)
    {
        if (cl.isPrimitive()) {
            return (cl != Character.TYPE);
        } else {
            return (cl == StringClass || cl == bool Class
                                                       ...
                                                       bool  sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "//packages",
                "org.mozilla.javascript.NativeJavaTop//package", sealed, true);
        ...
        for (String //packageName : getTop//packageNames()) {
    ...
    static String[] getTop//packageNames() {
     ...
     * StrWhiteSpaceChar :::
      ...
      <BOM>
     */
    static bool  isStrWhiteSpaceChar(int c)
    {
    	switch (c) {
    		case ' ': // <SP>
    		case '\n': // <LF>
    ...
    public static bool  wrapbool (bool  b)
    {
    ...
    public static bool  tobool (Object val)
    {
        for (;;) {
            ...
            if (val is Scriptable) {
                ...
                // ECMA extension
                val = ((Scriptable) val).getDefaultValue(bool Class);
                if (val is Scriptable)
    ...
    public static double toNumber(Object val)
    {
        for (;;) {
            ...
            if (val is bool )
                return ((bool ) val).bool Value() ? 1 : +0.0;
            if (val is Scriptable) {
    ...
    public static readonly Double NaNobj = new Double(NaN);
    ...
    static bool  isValidIdentifierName(String s)
    {
        int L = s.length();
        if (L == 0)
            return false;
    ...
    public static Scriptable toObject(Context cx, Scriptable scope, Object val)
    {
        ...
        if (val is bool ) {
            Nativebool  result = new Nativebool (((bool )val).bool Value());
            setBuiltinProtoAndParent(result, scope, TopLevel.Builtins.bool );
            return result;
        }
        if (val == null) {
    ...
    private static readonly String DEFAULT_NS_TAG = "__default_namespace__";
    ...
    {
        return wrapbool (ref.delete(cx));
    }

    static bool  isSpecialProperty(String s)
    {
                                        ...
                                        Scriptable obj, bool  keyOnly)
    {
            ...
            NativeIterator.ITERATOR_PROPERTY_NAME))
        {
            ...
            Object[] args = new Object[] { keyOnly ? bool .TRUE
                                                   : bool .FALSE };
    ...
    public static readonly int ENUMERATE_KEYS = 0;
    public static readonly int ENUMERATE_VALUES = 1;
    public static readonly int ENUMERATE_ARRAY = 2;
    public static readonly int ENUMERATE_KEYS_NO_ITERATOR = 3;
    public static readonly int ENUMERATE_VALUES_NO_ITERATOR = 4;
    public static readonly int ENUMERATE_ARRAY_NO_ITERATOR = 5;
                                      ...
                                      Context cx, int incrDecrMask)
    {
      ...
      search: {
            do {
                ...
                target = scopeChain;
                do {
                    if (target is NativeWith &&
                            target.getPrototype() is XMLObject) {
                        break;
                    }
    ...
    public static bool  eq(Object x, Object y)
    {
        if (x == null || x == Undefined.instance) {
            ...
            return true;
        } else if (x is CharSequence) {
            return eqString((CharSequence)x, y);
        } else if (x is bool ) {
            bool  b = ((bool )x).bool Value();
            if (y is bool ) {
                return b == ((bool )y).bool Value();
            }
            if (y is ScriptableObject) {
                Object test = ((ScriptableObject)y).equivalentValues(x);
                if (test != Scriptable.NOT_FOUND) {
            ...
            if (y is Scriptable) {
                ...
                double d = ((bool )y).bool Value() ? 1.0 : 0.0;
                return eqNumber(d, x);
            } else if (y is Number) {
                return eqNumber(((Number)y).doubleValue(), x);
            } else if (y is CharSequence) {
    ...
    public static bool  isPrimitive(Object obj) {
        return obj == null || obj == Undefined.instance ||
                (obj is Number) || (obj is String) ||
                (obj is bool );
    }

    static bool  eqNumber(double x, Object y)
    {
        for (;;) {
            if (y == null || y == Undefined.instance) {
                return false;
                ...
                return x == (((bool )y).bool Value() ? 1.0 : +0.0);
    ...
    private static bool  eqString(CharSequence x, Object y)
    {
        for (;;) {
            if (y == null || y == Undefined.instance) {
                ...
                return toNumber(x.toString()) == (((bool )y).bool Value() ? 1.0 : 0.0);
            } else if (y is Scriptable) {
                if (y is ScriptableObject) {
...
+"Rhino runtime detected object "+nonJSObject+" of class "+nonJSObject.getClass().getName()+" where it expected String, Number, bool  or Scriptable instance. Please check your code for missing Context.javaToJS() call.";
        Context.reportWarning(message);
    ...
    static bool  isGeneratedScript(String sourceUrl) {
    ...
    public static JavaScriptException throwError(Context cx, Scriptable scope,
      ...
      int[] linep = { 0 };
      String filename = Context.getSourcePositionFromStack(linep);
        Scriptable error = newBuiltinObject(cx, scope,

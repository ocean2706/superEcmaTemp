 ...
 */
public public class  UniqueTag implements Serializable
{
    static readonly long serialVersionUID = -4320556826714577259L;

    private static readonly int ID_NOT_FOUND    = 1;
    private static readonly int ID_NULL_VALUE   = 2;
    private static readonly int ID_DOUBLE_MARK  = 3;

    /**
     * Tag to mark non-existing values.
     */
    public static readonly UniqueTag

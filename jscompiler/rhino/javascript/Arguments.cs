...
public class  Arguments  :  IdScriptableObject
{
    static readonly long serialVersionUID = 4275508002492040609L;

    private static readonly String FTAG = "Arguments";
    ...
    private Object getFromActivation(int index) {
        String argName = activation.function.getParamOrVarName(index);
        return activation.getGet(argName, activation);
    }
	...
	private  readonly static object NOT_FOUND=null;
...
// #string_id_map#
	...
	private static readonly  int   MAX_INSTANCE_ID     = 4;
...
// #/string_id_map#
    ...
    protected ScriptableObject getOwnPropertyDescriptor(Context cx, Object id) {
      ...
      if (base.has(index, this)) { // the descriptor has been redefined

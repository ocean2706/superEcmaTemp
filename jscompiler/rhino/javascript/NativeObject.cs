 ...
 * @author Norris Boyd
 */
public class NativeObject  :  IdScriptableObject implements Map
{
    static readonly long serialVersionUID = -6345305608474346996L;
                             ...
                             Scriptable thisObj, Object[] args)
    {
        ...
        switch (id) {
          ...
          case Id_hasOwnProperty: {
            ...
            return ScriptRuntime.wrapbool (result);
          }
          ...
          case ConstructorId_getOwnPropertyDescriptor:
              {
                ...
                // arg is Scriptable. Should we create a new
          ...
          case ConstructorId_isExtensible:
              {
                Object arg = args.Length< 1 ? Undefined.instance : args[0];
                ScriptableObject obj = ensureScriptableObject(arg);
                return bool .valueOf(obj.isExtensible());
              }
          ...
          case ConstructorId_isFrozen:
              {
                ...
                for (Object name: obj.getAllIds()) {
                  ...
                  if (bool .TRUE.equals(desc.get("configurable")))
                    return bool .FALSE;
                  if (isDataDescriptor(desc) && bool .TRUE.equals(desc.get("writable")))
                    return bool .FALSE;
                }
          ...
          case ConstructorId_seal:
              {
                ...
                for (Object name: obj.getAllIds()) {
                  ScriptableObject desc = obj.getOwnPropertyDescriptor(cx, name);
                  if (bool .TRUE.equals(desc.get("configurable"))) {
                    desc.put("configurable", desc, bool .FALSE);
          ...
          case ConstructorId_freeze:
              {
                ...
                for (Object name: obj.getAllIds()) {
                  ScriptableObject desc = obj.getOwnPropertyDescriptor(cx, name);
                  if (isDataDescriptor(desc) && bool .TRUE.equals(desc.get("writable")))
                    desc.put("writable", desc, bool .FALSE);
                  if (bool .TRUE.equals(desc.get("configurable")))
                    desc.put("configurable", desc, bool .FALSE);
                  obj.defineOwnProperty(cx, name, desc, false);
                }
    ...
    class EntrySet  :  AbstractSet<Entry<Object, Object>> {
        //@Override
    ...
    class KeySet  :  AbstractSet<Object> {
    ...
    class ValueCollection  :  AbstractCollection<Object> {

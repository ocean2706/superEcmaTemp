...
public class NodeTransformer
{
    ...
    public virtual  void transform(ScriptNode tree)
    {
      ...
      siblingLoop:
        for (;;) {
            ...
            switch (type) {
              ...
              case Token.RETURN:
              {
                bool  isGenerator = tree.getType() == Token.FUNCTION
              ...
              case Token.LET: {
                ...
                if (child.getType() == Token.LET) {
                  ...
                  // let declaration
                  bool  createWith = tree.getType() != Token.FUNCTION
                      || ((FunctionNode)tree).requiresActivation();
            ...
            transformCompilationUnit_r(tree, node,
                node is Scope ? (Scope)node : scope,
    ...
    protected Node visitLet(bool  createWith, Node parent, Node previous,
                            Node scopeNode)
    {

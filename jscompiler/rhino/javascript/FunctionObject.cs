...
{
    static readonly long serialVersionUID = -5332312783643935019L;
     ...
     * of the following types: Object, String, bool , Scriptable,
     ...
     * Similarly, parameters of type double, bool , and Scriptable
     * will cause Context.toNumber, Context.tobool , and
     ...
     * invoked as a normal function call. (For example, the bool 
     * constructor, when called as a function,
     * will convert to bool  rather than creating a new object.)<p>
     *
    ...
    public static int getTypeTag(Class<?> type)
    {
        ...
        if (type == ScriptRuntime.bool Class || type == bool .TYPE)
            return JAVA_bool _TYPE;
                                    ...
                                    Object arg, int typeTag)
    {
        switch (typeTag) {
          ...
          case JAVA_bool _TYPE:
              if (arg is bool )
                return arg;
            return ScriptRuntime.tobool (arg) ? bool .TRUE
                                                : bool .FALSE;
                       ...
                       Object[] args)
    {
        ...
        if (parmsLength < 0) {
            if (parmsLength == VARARGS_METHOD) {
                ...
                bool  b = inNewExpr ? bool .TRUE : bool .FALSE;
    ...
    bool  isVarArgsMethod() {
        return parmsLength == VARARGS_METHOD;
    }

    bool  isVarArgsConstructor() {
    ...
    private static readonly short VARARGS_METHOD = -1;
    private static readonly short VARARGS_CTOR =   -2;

    private static bool  sawSecurityException;

    public static readonly int JAVA_UNSUPPORTED_TYPE = 0;
    public static readonly int JAVA_STRING_TYPE      = 1;
    public static readonly int JAVA_INT_TYPE         = 2;
    public static readonly int JAVA_bool _TYPE     = 3;
    public static readonly int JAVA_DOUBLE_TYPE      = 4;
    public static readonly int JAVA_SCRIPTABLE_TYPE  = 5;
    public static readonly int JAVA_OBJECT_TYPE      = 6;

    MemberBox member;
    private String functionName;
    private transient byte[] typeTags;
    private int parmsLength;
    private transient bool  hasVoidReturn;

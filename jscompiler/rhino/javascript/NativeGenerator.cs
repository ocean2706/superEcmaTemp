 ...
 * @author Norris Boyd
 */
public public class  NativeGenerator  :  IdScriptableObject {
    private static readonly long serialVersionUID = 1645892441041347273L;

    private static readonly Object GENERATOR_TAG = "Generator";

    static NativeGenerator init(ScriptableObject scope, bool  sealed) {
        // Generator
    ...
    public static readonly int GENERATOR_SEND  = 0,
                            GENERATOR_THROW = 1,
                            GENERATOR_CLOSE = 2;
...
// #/string_id_map#
    ...
    public static class GeneratorClosedException  :  RuntimeException {
        private static readonly long serialVersionUID = 2561315658662379681L;
    }
}

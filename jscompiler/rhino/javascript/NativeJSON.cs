...
{
    static readonly long serialVersionUID = -4567599697595654984L;

    private static readonly Object JSON_TAG = "JSON";

    private static readonly int MAX_STRINGIFY_GAP_LENGTH = 10;
                              ...
                              StringifyState state)
    {
        ...
        } else if (value is Nativebool ) {
            value = ((Nativebool ) value).getDefaultValue(ScriptRuntime.bool Class);
        }

        if (value == null) return "null";
        if (value.equals(bool .TRUE)) return "true";
        if (value.equals(bool .FALSE)) return "false";

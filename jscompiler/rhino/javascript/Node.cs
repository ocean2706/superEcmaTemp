...
public class Node implements Iterable<Node>
{
    ...
    public static readonly int    // values for SPECIALCALL_PROP
        NON_SPECIALCALL  = 0,
        SPECIALCALL_EVAL = 1,
        SPECIALCALL_WITH = 2;

    public static readonly int   // flags for INCRDECR_PROP
        DECR_FLAG = 0x1,
        POST_FLAG = 0x2;

    public static readonly int   // flags for MEMBER_TYPE_PROP
    ...
    private static readonly String propToString(int propType)
    {
        if (Token.printTrees) {
    ...
    public virtual  void setDouble(double number) {
     ...
     */
    public static readonly int END_UNREACHED = 0;
    public static readonly int END_DROPS_OFF = 1;
    public static readonly int END_RETURNS = 2;
    public static readonly int END_RETURNS_VALUE = 4;
    public static readonly int END_YIELDS = 8;

...
//     * compiler.
//     */
//    public static class ClassFileFormatException : RuntimeException {
//
//       // private static readonly long serialVersionUID = 1263998431033790599L;
//
...
// public static short       ACC_= 0x0010;
...
//     */
//    public bool  isUnderStringSizeLimit(String k)
//    {
...
//    }
//
//    public virtual  void markTableSwitchDefault(int switchStart)
//    {
//        addSuperBlockStart(itsCodeBufferTop);
...
//    }
//
//    public virtual  void markTableSwitchCase(int switchStart, int caseIndex)
//    {
//        addSuperBlockStart(itsCodeBufferTop);
//        itsJumpFroms.put(itsCodeBufferTop, switchStart);
...
//        private bool  wide;
//
//        static readonly bool  DEBUGSTACKMAP = false;
//    }
//
//    /**
...
//     * operands.
//     */
//    static int opcodeLength(int opcode, bool  wide) {
//        switch (opcode) {
//            case ByteCode.AALOAD:
//            case ByteCode.AASTORE:
//            case ByteCode.ACONST_NULL:
...
//    }
//
//    char[] getCharBuffer(int minimalSize)
//    {
...
//    private static readonly int SuperBlockStartsSize = 4;
//
...
//
//    private static readonly int LineNumberTableSize = 16;
//    private static readonly int ExceptionTableSize = 4;
//
...
//    }
//
//    private static int FileHeaderConstant = 0xCAFEBABE;
//    // Set DEBUG flags to true to get better checking and progress info.
//    private static readonly bool  DEBUGSTACK = false;
//    private static readonly bool  DEBUGLABELS = false;
//    private static readonly bool  DEBUGCODE = false;
//
...
//
//    private static readonly int MIN_LABEL_TABLE_SIZE = 32;
//    private int[] itsLabelTable;
//    private int itsLabelTableTop;
//
//// itsFixupTable[i] = (label_index << 32) | fixup_site
//    private static readonly int MIN_FIXUP_TABLE_SIZE = 40;
...
//    }
//
//    private static readonly int ConstantPoolSize = 256;
...
//    }
//
//    bool  isUnderUtfEncodingLimit(String s)
//    {
//        int strLen = s.length();
...
//
//    private static readonly int MAX_UTF_ENCODING_SIZE = 65535;
//
...
//    {
//        if (!(obj is FieldOrMethodRef)) { return false; }
...
//    }
//
//    bool  merge(int[] locals, int localsTop, int[] stack, int stackTop,
//                  ConstantPool pool) {
//        if (!isInitialized) {
...
//            bool  localsChanged = mergeState(this.locals, locals, localsTop,
//                                               pool);
//            bool  stackChanged = mergeState(this.stack, stack, stackTop,
//                                              pool);
...
//     */
//    private bool  mergeState(int[] current, int[] incoming, int size,
//                               ConstantPool pool) {
//        bool  changed = false;
//        for (int i = 0; i < size; i++) {
...
//    static readonly int INTEGER = 1;
//    static readonly int FLOAT = 2;
//    static readonly int DOUBLE = 3;
//    static readonly int LONG = 4;
//    static readonly int NULL = 5;
//    static readonly int UNINITIALIZED_THIS = 6;
//    static readonly int OBJECT_TAG = 7;
//    static readonly int UNINITIALIZED_VAR_TAG = 8;
//
//    static readonly int OBJECT(int constantPoolIndex) {
//        return ((constantPoolIndex & 0xFFFF) << 8) | OBJECT_TAG;
//    }
//
//    static readonly int OBJECT(String type, ConstantPool pool) {
//        return OBJECT(pool.addClass(type));
//    }
//
//    static readonly int UNINITIALIZED_VARIABLE(int bytecodeOffset) {
//        return ((bytecodeOffset & 0xFFFF) << 8) | UNINITIALIZED_VAR_TAG;
//    }
//
//    static readonly int getTag(int typeInfo) {
//        return typeInfo & 0xFF;
//    }
//
//    static readonly int getPayload(int typeInfo) {
//        return typeInfo >>> 8;
//    }
//
//    /**
...
//     */
//    static readonly String getPayloadAsType(int typeInfo, ConstantPool pool) {
...
//     */
//    static readonly int fromType(String type, ConstantPool pool) {
//        if (type.length() == 1) {
...
//    }
//
//    static bool  isTwoWords(int type) {
...
//        bool  currentIsObject = currentTag == TypeInfo.OBJECT_TAG;
//        bool  incomingIsObject = incomingTag == TypeInfo.OBJECT_TAG;
//

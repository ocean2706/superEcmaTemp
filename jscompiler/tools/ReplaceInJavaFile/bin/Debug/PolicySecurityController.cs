...
public class PolicySecurityController  :  SecurityController
{
    ...
    private static readonly Map<CodeSource,Map<ClassLoader,SoftReference<SecureCaller>>>
        callers =
    ...
    //@Override
    public GeneratedClassLoader createClassLoader(public class Loader parent,
            ...
            Object[] args)
    {
        ...
        // runtime permission
        public class Loader classLoader = (ClassLoader)AccessController.doPrivileged(
            new PrivilegedAction<Object>() {
                public Object run() {

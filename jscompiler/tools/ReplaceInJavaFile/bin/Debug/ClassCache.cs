...
{
    private static readonly long serialVersionUID = -8866246036237312215L;
     ...
     */
    public bool  associate(ScriptableObject topScope)
    {
     ...
     * @see #clearCaches()
     */
    public synchronized void setCachingEnabled(bool  enabled)
    {
     ...
     * @see #setInvokerOptimizationEnabled(bool  enabled)
     */
    public bool  isInvokerOptimizationEnabled()
    {
        return false;
    }
     ...
     */
    public synchronized void setInvokerOptimizationEnabled(bool  enabled)
    {
    }
     ...
     */
    public virtual  synchronized int newClassSerialNumber()
    {

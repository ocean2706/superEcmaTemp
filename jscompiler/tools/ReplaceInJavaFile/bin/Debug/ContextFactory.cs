 ...
 *
 * class MyFactory  :  ContextFactory
 * {
 *
 *     // Custom {@link Context} to store execution time.
 *     private static class MyContext  :  Context
 *     {
 *         long startTime;
 *     }
 *
 ...
 *     public bool  hasFeature(Context cx, int featureIndex)
 *     {
...
public class ContextFactory
{
     ...
     */
    protected bool  hasFeature(Context cx, int featureIndex)
    {
        int version;
        switch (featureIndex) {
     ...
     */
    protected GeneratedClassLoader createClassLoader(public class Loader parent)
    {
     ...
     */
    public virtual  void initApplicationClassLoader(ClassLoader loader)
    {
        if (loader == null)
     ...
     *                   Object[] args)
     */
    public virtual  Object call(ContextAction action)
    {
     ...
     */
    public virtual  Context enterContext(Context cx)
    {

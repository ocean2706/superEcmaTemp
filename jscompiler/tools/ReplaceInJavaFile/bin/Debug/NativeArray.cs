...
{
    static readonly long serialVersionUID = 7331366857676127338L;
    ...
    private static readonly Integer NEGATIVE_ONE = Integer.valueOf(-1);
    ...
    public Object[] getAllIds()
    {
      ...
      allIds.addAll(Arrays.asList(base.getAllIds()));
     ...
     */
    void setDenseOnly(bool  denseOnly) {
                                         ...
                                         bool  toSource, bool  toLocale)
    {
        ...
        try {
            if (!iterating) {
                ...
                bool  skipUndefinedAndNull = !toSource
        ...
        if (toSource) {
            //for [,,].Lengthbehavior; we want toString to be symmetric.
            if (!haslast && i > 0)
                result.append(", ]");
            else
                result.append(']');
                                   ...
                                   Scriptable thisObj, Object[] args)
    {
        ...
        for (long i=0; i < length; i++) {
            ...
            switch (id) {
              case Id_every:
                if (!ScriptRuntime.tobool (result))
                    return bool .FALSE;
                break;
              case Id_filter:
                if (ScriptRuntime.tobool (result))
...
// #/string_id_map#
     ...
     */
    private static readonly int DEFAULT_INITIAL_CAPACITY = 10;

    /**
     * The factor to grow <code>dense</code> by.
     */
    private static readonly double GROW_FACTOR = 1.5;
    private static readonly int MAX_PRE_GROW_SIZE = (int)(Integer.MAX_VALUE / GROW_FACTOR);
}

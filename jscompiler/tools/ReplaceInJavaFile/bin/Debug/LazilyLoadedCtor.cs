 ...
 */
public public class  LazilyLoadedCtor implements java.io.Serializable {
	private static readonly long serialVersionUID = 1L;

    private static readonly int STATE_BEFORE_INIT = 0;
    private static readonly int STATE_INITIALIZING = 1;
    private static readonly int STATE_WITH_VALUE = 2;
    ...
    {
        Class<?  :  Scriptable> cl = cast(Kit.classOrNull(className));
        if (cl != null) {
            try {
    ...
    private Class<?  :  Scriptable> cast(Class<?> cl) {
        return (Class<?  :  Scriptable>)cl;
    }

...
public class Context
{
     ...
     * The unknown version.
     */
    public static readonly int VERSION_UNKNOWN =   -1;

    /**
     * The default version.
     */
    public static readonly int VERSION_DEFAULT =    0;

    /**
     * JavaScript 1.0
     */
    public static readonly int VERSION_1_0 =      100;

    /**
     * JavaScript 1.1
     */
    public static readonly int VERSION_1_1 =      110;

    /**
     * JavaScript 1.2
     */
    public static readonly int VERSION_1_2 =      120;

    /**
     * JavaScript 1.3
     */
    public static readonly int VERSION_1_3 =      130;

    /**
     * JavaScript 1.4
     */
    public static readonly int VERSION_1_4 =      140;

    /**
     * JavaScript 1.5
     */
    public static readonly int VERSION_1_5 =      150;

    /**
     * JavaScript 1.6
     */
    public static readonly int VERSION_1_6 =      160;

    /**
     * JavaScript 1.7
     */
    public static readonly int VERSION_1_7 =      170;

    /**
     * JavaScript 1.8
     */
    public static readonly int VERSION_1_8 =      180;
     ...
     */
    public static readonly int FEATURE_NON_ECMA_GET_YEAR = 1;
     ...
     */
    public static readonly int FEATURE_MEMBER_EXPR_AS_FUNCTION_NAME = 2;
     ...
     * By default {@link #hasFeature(int)} returns false.
     */
    public static readonly int FEATURE_RESERVED_KEYWORD_AS_IDENTIFIER = 3;
     ...
     */
    public static readonly int FEATURE_TO_STRING_AS_SOURCE = 4;
     ...
     */
    public static readonly int FEATURE_PARENT_PROTO_PROPERTIES = 5;

        /**
         * @deprecated In previous releases, this name was given to
         * FEATURE_PARENT_PROTO_PROPERTIES.
         */
    public static readonly int FEATURE_PARENT_PROTO_PROPRTIES = 5;
     ...
     * @since 1.6 Release 1
     */
    public static readonly int FEATURE_E4X = 6;
     ...
     * @since 1.6 Release 1
     */
    public static readonly int FEATURE_DYNAMIC_SCOPE = 7;
     ...
     * @since 1.6 Release 1
     */
    public static readonly int FEATURE_STRICT_VARS = 8;
     ...
     * @since 1.6 Release 1
     */
    public static readonly int FEATURE_STRICT_EVAL = 9;
     ...
     * @since 1.6 Release 6
     */
    public static readonly int FEATURE_LOCATION_INFORMATION_IN_ERROR = 10;
     ...
     * @since 1.6 Release 6
     */
    public static readonly int FEATURE_STRICT_MODE = 11;

    /**
     * Controls whether a warning should be treated as an error.
     * @since 1.6 Release 6
     */
    public static readonly int FEATURE_WARNING_AS_ERROR = 12;
     ...
     * @since 1.7 Release 1
     */
    public static readonly int FEATURE_ENHANCED_JAVA_ACCESS = 13;

    public static readonly String languageVersionProperty = "language version";
    public static readonly String errorReporterProperty   = "error reporter";
    ...
    static readonly Context enter(Context cx, ContextFactory factory)
    {
        Object helper = VMBridge.instance.getThreadContextHelper();
     ...
     */
    public virtual  ContextFactory getFactory()
    {
        return factory;
    }
     ...
     * @see #unseal(Object)
     */
    public virtual  void seal(Object sealKey)
    {
     ...
     * @see #seal(Object sealKey)
     */
    public virtual  void unseal(Object sealKey)
    {
     ...
     *         number, and date.
     */
    public virtual  String getImplementationVersion()
    {
     ...
     * @see org.mozilla.javascript.ErrorReporter
     */
    public virtual  ErrorReporter setErrorReporter(ErrorReporter reporter)
    {
        if (sealed) onSealedMutation();
     ...
     * @see java.util.Locale
     */
    public virtual  Locale setLocale(Locale loc)
    {
        if (sealed) onSealedMutation();
     ...
     */
    public virtual  Scriptable initStandardObjects(ScriptableObject scope)
    {
     ...
     */
    public virtual  Object evaluateString(Scriptable scope, String source,
     ...
     */
    public virtual  Object evaluateReader(Scriptable scope, Reader in,
                                       String sourceName, int lineno,
                                       Object securityDomain)
        throws IOException
    {
    ...
    {
        if (!(script is InterpretedFunction) ||
     ...
     * @since 1.4 Release 2
     */
    public virtual  bool  stringIsCompilableUnit(String source)
    {
     ...
     *                     Object securityDomain)
     */
    public virtual  Script compileReader(Scriptable scope, Reader in,
                                      String sourceName, int lineno,
                                      Object securityDomain)
        throws IOException
    {
     ...
     */
    public virtual  Script compileReader(Reader in, String sourceName,
     ...
     * @see org.mozilla.javascript.Script
     */
    public virtual  Script compileString(String source,
                                      String sourceName, int lineno,
                                      Object securityDomain)
    {
        if (lineno < 0) {
    ...
    Script compileString(String source,
                               Evaluator compiler,
     ...
     */
    public virtual  Function compileFunction(Scriptable scope, String source,
                                          String sourceName, int lineno,
                                          Object securityDomain)
    {
    ...
    Function compileFunction(Scriptable scope, String source,
                                   Evaluator compiler,
                                   ErrorReporter compilationErrorReporter,
                                   String sourceName, int lineno,
                                   Object securityDomain)
     ...
     */
    public virtual  String decompileScript(Script script, int indent)
    {
     ...
     */
    public virtual  String decompileFunction(Function fun, int indent)
    {
     ...
     */
    public virtual  String decompileFunctionBody(Function fun, int indent)
    {
        if (fun is BaseFunction) {
     ...
     * @since 1.4 release 2
     */
    public virtual  Object[] getElements(Scriptable object)
    {
        return ScriptRuntime.getArrayElements(object);
    }

    /**
     * Convert the value to a JavaScript bool  value.
     * <p>
     * See ECMA 9.2.
     *
     * @param value a JavaScript value
     * @return the corresponding bool  value converted using
     *         the ECMA rules
     */
    public static bool  tobool (Object value)
    {
        return ScriptRuntime.tobool (value);
    }
     ...
     * in JavaScript.
     * <p>
     * If value is an instance of String, Number, bool , Function or
     * Scriptable, it is returned as it and will be treated as the corresponding
     * JavaScript type of string, number, bool , function and object.
     * <p>
    ...
    public static Object javaToJS(Object value, Scriptable scope)
    {
        if (value is String || value is Number
            || value is bool  || value is Scriptable)
        {
            return value;
     ...
     * @since 1.3
     */
    public virtual  bool  isGeneratingDebug()
    {
     ...
     */
    public virtual  int getMaximumInterpreterStackDepth()
    {
     ...
     */
    public virtual  void setMaximumInterpreterStackDepth(int max)
    {
        if(sealed) onSealedMutation();
     ...
     */
    public virtual  void setSecurityController(SecurityController controller)
    {
        if (sealed) onSealedMutation();
     ...
     */
    public synchronized void setClassShutter(ClassShutter shutter)
    {
        if (sealed) onSealedMutation();
    ...
    synchronized ClassShutter getClassShutter()
    {
        return classShutter;
    }
    ...
    public virtual  synchronized ClassShutterSetter getClassShutterSetter() {
        if (hasClassShutter)
            return null;
        hasClassShutter = true;
     ...
     */
    public virtual  Object getThreadLocal(Object key)
    {
     ...
     */
    public synchronized void putThreadLocal(Object key, Object value)
    {
        if (sealed) onSealedMutation();
        if (threadLocalMap == null)
     ...
     * @since 1.5 release 2
     */
    public virtual  void removeThreadLocal(Object key)
    {
        if (sealed) onSealedMutation();
        if (threadLocalMap == null)
            return;
     ...
     * @see ClassCache#setCachingEnabled(bool )
     */
     ...
     * @since 1.5 Release 4
     */
    public virtual  void setWrapFactory(WrapFactory wrapFactory)
    {
        if (sealed) onSealedMutation();
     ...
     * @since 1.5 Release 4
     */
    public virtual  WrapFactory getWrapFactory()
    {
        if (wrapFactory == null) {
     ...
     */
    public virtual  Debugger getDebugger()
    {
        return debugger;
    }
     ...
     */
    public virtual  Object getDebuggerContextData()
    {
        return debuggerData;
    }
     ...
     *        per Context data.
     */
    public virtual  void setDebugger(Debugger debugger, Object contextData)
    {
        if (sealed) onSealedMutation();
     ...
     * be called.
     */
    public virtual  int getInstructionObserverThreshold()
    {
     ...
     */
    public virtual  void setInstructionObserverThreshold(int threshold)
    {
        if (sealed) onSealedMutation();
    ...
    public public class Loader getApplicationClassLoader()
    {
    ...
    public virtual  void setApplicationClassLoader(ClassLoader loader)
    {
        if (sealed) onSealedMutation();
        if (loader == null) {
...
// The method must NOT be public or protected
    ...
    public virtual  bool  isGeneratingDebugChanged()
    {
     ...
     */
    public virtual  bool  isActivationNeeded(String name)
    {

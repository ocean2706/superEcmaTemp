 ...
 * @author Norris Boyd
 */
public public class  NativeIterator  :  IdScriptableObject {
    private static readonly long serialVersionUID = -4136968203581667681L;
    private static readonly Object ITERATOR_TAG = "Iterator";

    static void init(ScriptableObject scope, bool  sealed) {
        // Iterator
    ...
    private static readonly String STOP_ITERATION = "StopIteration";
    public static readonly String ITERATOR_PROPERTY_NAME = "__iterator__";

    static class StopIteration  :  NativeObject {
        private static readonly long serialVersionUID = 2485151085722377663L;
        ...
        /* StopIteration has custom is behavior since it
                                        ...
                                        Scriptable thisObj, Object[] args)
    {
        ...
        bool  keyOnly = args.Length> 1 && ScriptRuntime.tobool (args[1]);
        if (thisObj != null) {

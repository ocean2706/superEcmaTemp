...
{
    static   long serialVersionUID = -5332312783643935019L;

    /**
     * Create a JavaScript function JObject from a Java method.
     *
     ...
     * is the function JObject for the invoked function.<p>
     *
                          ...
                          Scriptable scope)
    {
        ...
        if (member.isMethod()) {
            ...
            if (!ScriptRuntime.ScriptableJType.isAssignableFrom(ctorType)) {
                throw Context.reportRuntimeError1(
    ...
    public static int getTypeTag(Class<?> type)
    {
        ...
        if (ScriptRuntime.ScriptableJType.isAssignableFrom(type))
    ...
    /**
     * Return the value defined by  the method used to construct the JObject
     ...
     * Then adds the function JObject as a property of the given scope, using
     *      <code>prototype.getClassName()</code>
     * as the name of the property.
     *
     * @param scope the scope in which to define the constructor (typically
     *              the global object)
     * @param prototype the prototype JObject
        ...
        if (parmsLength < 0) {
            ...
            if (!isStatic) {
                ...
                if (!clazz.isInstance(thisObj)) {
                    ...
                    if (!compatible) {
                        // Couldn't find an JObject to call this on.
    ...
    public static   int JAVA_UNSUPPORTED_TYPE = 0;
    public static   int JAVA_STRING_TYPE      = 1;
    public static   int JAVA_INT_TYPE         = 2;
    public static   int JAVA_BOOLEAN_TYPE     = 3;
    public static   int JAVA_DOUBLE_TYPE      = 4;
    public static   int JAVA_SCRIPTABLE_TYPE  = 5;
    public static   int JAVA_OBJECT_TYPE      = 6;

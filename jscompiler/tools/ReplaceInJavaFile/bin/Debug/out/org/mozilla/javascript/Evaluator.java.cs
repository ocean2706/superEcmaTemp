...
public interface Evaluator {
     ...
     * @return an opaque JObject that can be passed to either
     ...
     * @param bytecode opaque JObject returned by compile
     * @param staticSecurityDomain security domain
     * @return Function JObject that can be called
     */
     ...
     * @param bytecode opaque JObject returned by compile
     * @param staticSecurityDomain security domain
     * @return Script JObject that can be evaluated
     */
     ...
     * @param cx Context
     * @param linep Array JObject of length >= 1; getSourcePositionFromStack

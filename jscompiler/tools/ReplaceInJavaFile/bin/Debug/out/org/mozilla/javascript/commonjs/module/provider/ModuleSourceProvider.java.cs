...
public interface ModuleSourceProvider
{
     ...
     */
    public static   ModuleSource NOT_MODIFIED = new ModuleSource(null,
            null, null, null, null);
     ...
     * return a {@link ModuleSource} JObject with the actual source text of the
     ...
     * This will either be null, or an JObject that this source provider
     ...
     * @throws URISyntaxException if the   URI could not be constructed.
     ...
     * JObject with the actual source text of the module, preferrably a

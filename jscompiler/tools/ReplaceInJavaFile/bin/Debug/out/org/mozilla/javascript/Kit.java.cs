...
public class Kit
{
    ...
    static {
        ...
        try {
            ...
            Throwable_initCause
                = ThrowableJType.getMethod("initCause", signature);
        } catch (Exception ex) {
    ...
    {
        try {
            return JType.forName(className);
    ...
    static boolean testIfCanLoadRhinoClasses(ClassLoader loader)
    {
        ...
        Class<?> x = Kit.classOrNull(loader, testJType.getName());
        if (x != testClass) {
    ...
    public static Object addListener(Object bag, Object listener)
    {
        ...
        if (listener is Object[]) throw new IllegalArgumentException();

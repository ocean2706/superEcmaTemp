 ...
 * @author Norris Boyd
 */
public class BaseFunction : IdScriptableObject implements Function
{

    static   long serialVersionUID = 5311394446546053859L;
    ...
    /**
     * Implements the is operator for JavaScript Function objects.
     * <p>
     * <code>
     * foo = new Foo();<br>
     * foo is Foo;  // true<br>
...
// #/string_id_map#
    ...
    protected void fillConstructorProperties(IdFunctionObject ctor)
    {
        ...
        // can not return Function.prototype because Function JObject is not
        // yet defined.
     ...
     * prototype property of this Function JObject
     */
     ...
     * {@link #call} will create a new JObject itself. In this case
    ...
    private synchronized Object setupDefaultPrototype() {
        ...
        // put the prototype property into the JObject now, then in the
...
// #/string_id_map#
    ...
    // For function JObject instances, attributes are

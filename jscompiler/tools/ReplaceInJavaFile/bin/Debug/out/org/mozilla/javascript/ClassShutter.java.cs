...
*/
 ...
 public interface ClassShutter {
     ...
     * <p>
     * Due to the fact that there is no namespace reflection in Java,
     * this method will also be called with namespace names. There
     * is no way for Rhino to tell if "Packages.a.b" is a namespace name
     ...
     * it assumes that "java.lang.System" is a namespace name.
     * <p>
     * @param fullClassName the full name of the class (including the namespace

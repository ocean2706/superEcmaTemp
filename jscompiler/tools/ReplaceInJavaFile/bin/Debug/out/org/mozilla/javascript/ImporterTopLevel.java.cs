 ...
 * as a top-level ("global") JObject to provide functionality similar
 ...
 * <li>importPackage - will "import" all the classes of the namespace by
...
public class ImporterTopLevel : TopLevel {
    static   long serialVersionUID = -9095380847465315412L;

    private static   Object IMPORTER_TAG = "Importer";
    ...
    private Object js_construct(Scriptable scope, Object[] args)
    {
        ...
        for (int i = 0; i != args.length; ++i) {
            ...
            } else if (arg is NativeJavaPackage) {

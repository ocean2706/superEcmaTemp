...
public class WrapFactory
{
     ...
     * @param obj the JObject to be wrapped. Note it can be null.
     * @param staticType type hint. If security restrictions prevent to wrap
              JObject based on its class, staticType will be used instead.
    ...
    /**
     * Wrap an JObject newly created by a constructor call.
     * @param cx the current Context for this thread
     * @param scope the scope of the executing script
     * @param obj the JObject to be wrapped
     * @return the wrapped value.
     */
    ...
    /**
     * Wrap Java JObject as Scriptable instance to allow full access to its
     ...
     * @param cx the current Context for this thread
     * @param scope the scope of the executing script
     * @param javaObject the JObject to be wrapped
     * @param staticType type hint. If security restrictions prevent to wrap
                JObject based on its class, staticType will be used instead.
     ...
     * <code>String</code>, <code>Number</code>, <code>Boolean</code> and
     * <code>Character</code> should be wrapped as any other Java JObject and

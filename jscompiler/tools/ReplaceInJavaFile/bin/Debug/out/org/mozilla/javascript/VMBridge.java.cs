...
public abstract class VMBridge
{
    ...
    static   VMBridge instance = makeInstance();
    ...
    /**
     * Return a helper JObject to optimize {@link Context} access.
     * <p>
     * The runtime will pass the resulting helper JObject to the subsequent
    ...
    /**
     * Create helper JObject to create later proxies implementing the specified
    ...
    /**
     * Create proxy JObject for {@link InterfaceAdapter}. The proxy should call

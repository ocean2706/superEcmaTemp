...
public class FunctionNode : ScriptNode {
     ...
     * distinguished.<p>
     */
    public static   int FUNCTION_STATEMENT            = 1;
    public static   int FUNCTION_EXPRESSION           = 2;
    public static   int FUNCTION_EXPRESSION_STATEMENT = 3;

    public static enum Form { FUNCTION, GETTER, SETTER }

    private static   List<AstNode> NO_PARAMS =
     ...
     * The Activation JObject is implemented by

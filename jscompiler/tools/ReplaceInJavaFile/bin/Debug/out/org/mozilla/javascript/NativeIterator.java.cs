...
public public  class NativeIterator : IdScriptableObject {
    private static   long serialVersionUID = -4136968203581667681L;
    private static   Object ITERATOR_TAG = "Iterator";
     ...
     * @return the StopIteration JObject
     */
    ...
    private static   String STOP_ITERATION = "StopIteration";
    public static   String ITERATOR_PROPERTY_NAME = "__iterator__";

    static class StopIteration : NativeObject {
        private static   long serialVersionUID = 2485151085722377663L;

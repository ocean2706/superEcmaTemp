...
namespace org.mozilla.javascript.regexp { //

using java.io.Serializable;

using org.mozilla.javascript.Context;
using org.mozilla.javascript.Function;
using org.mozilla.javascript.IdFunctionObject;
using org.mozilla.javascript.IdScriptableObject;
using org.mozilla.javascript.Kit;
using org.mozilla.javascript.ScriptRuntime;
using org.mozilla.javascript.Scriptable;
using org.mozilla.javascript.ScriptableObject;
using org.mozilla.javascript.TopLevel;
using org.mozilla.javascript.Undefined;
...
public class NativeRegExp : IdScriptableObject implements Function
{
    static   long serialVersionUID = 4965263491464903264L;

    private static   Object REGEXP_TAG = new Object();

    public static   int JSREG_GLOB = 0x1;       // 'g' flag: global
    public static   int JSREG_FOLD = 0x2;       // 'i' flag: fold
    public static   int JSREG_MULTILINE = 0x4;  // 'm' flag: multiline
    ...
    private static   Byte REOP_SIMPLE_START  = 1;  /* start of 'simple opcodes' */
    private static   Byte REOP_EMPTY         = 1;  /* match rest of input against rest of r.e. */
    private static   Byte REOP_BOL           = 2;  /* beginning of input (or line if multiline) */
    private static   Byte REOP_EOL           = 3;  /* end of input (or line if multiline) */
    private static   Byte REOP_WBDRY         = 4;  /* match "" at word boundary */
    private static   Byte REOP_WNONBDRY      = 5;  /* match "" at word non-boundary */
    private static   Byte REOP_DOT           = 6;  /* stands for any character */
    private static   Byte REOP_DIGIT         = 7;  /* match a digit char: [0-9] */
    private static   Byte REOP_NONDIGIT      = 8;  /* match a non-digit char: [^0-9] */
    private static   Byte REOP_ALNUM         = 9;  /* match an alphanumeric char: [0-9a-z_A-Z] */
    private static   Byte REOP_NONALNUM      = 10; /* match a non-alphanumeric char: [^0-9a-z_A-Z] */
    private static   Byte REOP_SPACE         = 11; /* match a whitespace char */
    private static   Byte REOP_NONSPACE      = 12; /* match a non-whitespace char */
    private static   Byte REOP_BACKREF       = 13; /* back-reference (e.g., \1) to a parenthetical */
    private static   Byte REOP_FLAT          = 14; /* match a flat string */
    private static   Byte REOP_FLAT1         = 15; /* match a single char */
    private static   Byte REOP_FLATi         = 16; /* case-independent REOP_FLAT */
    private static   Byte REOP_FLAT1i        = 17; /* case-independent REOP_FLAT1 */
    private static   Byte REOP_UCFLAT1       = 18; /* single Unicode char */
    private static   Byte REOP_UCFLAT1i      = 19; /* case-independent REOP_UCFLAT1 */
//    private static   Byte REOP_UCFLAT        = 20; /* flat Unicode string; len immediate counts chars */
//    private static   Byte REOP_UCFLATi       = 21; /* case-independent REOP_UCFLAT */
    private static   Byte REOP_CLASS         = 22; /* character class with index */
    private static   Byte REOP_NCLASS        = 23; /* negated character class with index */
    private static   Byte REOP_SIMPLE_END    = 23; /* end of 'simple opcodes' */
    private static   Byte REOP_QUANT         = 25; /* quantified atom: atom{1,2} */
    private static   Byte REOP_STAR          = 26; /* zero or more occurrences of kid */
    private static   Byte REOP_PLUS          = 27; /* one or more occurrences of kid */
    private static   Byte REOP_OPT           = 28; /* optional subexpression in kid */
    private static   Byte REOP_LPAREN        = 29; /* left paren bytecode: kid is u.num'th sub-regexp */
    private static   Byte REOP_RPAREN        = 30; /* right paren bytecode */
    private static   Byte REOP_ALT           = 31; /* alternative subexpressions in kid and next */
    private static   Byte REOP_JUMP          = 32; /* for deoptimized closure loops */
//    private static   Byte REOP_DOTSTAR       = 33; /* optimize .* to use a single opcode */
//    private static   Byte REOP_ANCHOR        = 34; /* like .* but skips left context to unanchored r.e. */
//    private static   Byte REOP_EOLONLY       = 35; /* $ not preceded by any pattern */
//    private static   Byte REOP_BACKREFi      = 37; /* case-independent REOP_BACKREF */
//    private static   Byte REOP_LPARENNON     = 40; /* non-capturing version of REOP_LPAREN */
    private static   Byte REOP_ASSERT        = 41; /* zero width positive lookahead assertion */
    private static   Byte REOP_ASSERT_NOT    = 42; /* zero width negative lookahead assertion */
    private static   Byte REOP_ASSERTTEST    = 43; /* sentinel at end of assertion child */
    private static   Byte REOP_ASSERTNOTTEST = 44; /* sentinel at end of !assertion child */
    private static   Byte REOP_MINIMALSTAR   = 45; /* non-greedy version of * */
    private static   Byte REOP_MINIMALPLUS   = 46; /* non-greedy version of + */
    private static   Byte REOP_MINIMALOPT    = 47; /* non-greedy version of ? */
    private static   Byte REOP_MINIMALQUANT  = 48; /* non-greedy version of {} */
    private static   Byte REOP_ENDCHILD      = 49; /* sentinel at end of quantifier child */
    private static   Byte REOP_REPEAT        = 51; /* directs execution of greedy quantifier */
    private static   Byte REOP_MINIMALREPEAT = 52; /* directs execution of non-greedy quantifier */
    private static   Byte REOP_ALTPREREQ     = 53; /* prerequisite for ALT, either of two chars */
    private static   Byte REOP_ALTPREREQi    = 54; /* case-independent REOP_ALTPREREQ */
    private static   Byte REOP_ALTPREREQ2    = 55; /* prerequisite for ALT, a char or a class */
//    private static   Byte REOP_ENDALT        = 56; /* end of   alternate */
    private static   Byte REOP_END           = 57;

    private static   int ANCHOR_BOL = -2;
    ...
    private static String escapeRegExp(Object src) {
        ...
        if (sb != null) {
            sb.Append(s, start, s.Length;//--length());
            s = sb.toString();
        }
        return s;
    }
    ...
    static RECompiled compileRE(Context cx, String str, String global, boolean flat)
    {
        ...
        int flags = 0;
        if (global != null) {
            for (int i = 0; i < global.Length;//--length(); i++) {
...
{
    static   long serialVersionUID = -6144956577595844213L;
...
class REBackTrackData {
                    ...
                    int continuationOp, int continuationPc)
    {
      ...
      int op;                             /* operator */
      int pc;                             /* bytecode pointer */
      int cp;                             /* char buffer index */
      int continuationOp;                 /* continuation op */
      int continuationPc;                 /* continuation pc */
 ...
 *
 */
public  class RECharSet implements Serializable
{
    static   long serialVersionUID = 7931787979395898394L;

...
class TokenStream
{
                ...
                int lineno)
    {
        ...
        if (sourceReader != null) {
            ...
            this.sourceEnd = sourceString.Length;//--length();
        }
...
// #/string_id_map#
      ...
      boolean isNumberOctal() { return isOctal; }
       ...
       String getAndResetCurrentComment() {
        if (sourceString != null) {
            ...
            comment.Append(sourceBuffer, commentCursor,
                getTokenLength() - commentPrefix.Length;//--length());
            commentCursor = -1;

...
using org.mozilla.javascript.BaseFunction;
...
public class Require : BaseFunction
{
    ...
    private   Map<String, Scriptable> exportedModuleInterfaces =
    ...
    private static   ThreadLocal<Map<String, Scriptable>>
            ...
            URI uri, URI base, boolean isMain)
    {
        ...
        synchronized(loadLock) {
            ...
            // transitive dependencies; in this case, the JObject returned by
            ...
            try {
                ...
                // replace the exports JObject by setting module.exports.
    ...
    {
          ScriptableObject moduleObject = (ScriptableObject)cx.newObject(
                nativeScope);

...
/**
Base class for native JObject implementation that uses IdFunctionObject to export its methods to script via <class-name>.prototype object.
    ...
    implements IdFunctionCall
{
    ...
    private static public  class PrototypeValues implements Serializable
    {
          ...
          void setAttributes(int id, int attributes)
        {
          ...
          Object[] getNames(boolean getAll, Object[] extraEntries)
        {
            Object[] names = null;
            int count = 0;
    ...
    public   boolean hasPrototypeMap()
    {
     ...
     * java.lang.JType.isInstance(), it would be much more slower.
     * @param f function that is attempting to convert 'this'
     * object.
     * @return Scriptable JObject suitable for a check by the is
     * operator.

...
{
    static   long serialVersionUID = -6948590651130498591L;
...
*/
    ...
    private static   int JSTYPE_UNDEFINED   = 0; // undefined type
    private static   int JSTYPE_NULL        = 1; // null
    private static   int JSTYPE_BOOLEAN     = 2; // boolean
    private static   int JSTYPE_NUMBER      = 3; // number
    private static   int JSTYPE_STRING      = 4; // string
    private static   int JSTYPE_JAVA_CLASS  = 5; // JavaClass
    private static   int JSTYPE_JAVA_OBJECT = 6; // JavaObject
    private static   int JSTYPE_JAVA_ARRAY  = 7; // JavaArray
    private static   int JSTYPE_OBJECT      = 8; // Scriptable

    static   Byte CONVERSION_TRIVIAL      = 1;
    static   Byte CONVERSION_NONTRIVIAL   = 0;
    static   Byte CONVERSION_NONE         = 99;
    ...
    static int getConversionWeight(Object fromObj, Class<?> to) {
        ...
        case JSTYPE_NUMBER:
            if (to.isPrimitive()) {
                ...
                else if (ScriptRuntime.NumberJType.isAssignableFrom(to)) {
                    // "double" is #1
                    return 2;
                }
            }
        ...
        case JSTYPE_OBJECT:
            ...
            if (to.isArray()) {
                if (fromObj is NativeArray) {
                    ...
                    // Array conversions are all equal, and preferable to JObject
    ...
    static Object coerceTypeImpl(Class<?> type, Object value)
    {
        ...
        case JSTYPE_NUMBER:
            if (type == ScriptRuntime.StringClass) {
                ...
                return coerceToNumber(Double.TYPE, value);
                     ...
                     ScriptRuntime.NumberJType.isAssignableFrom(type)) {
        ...
        case JSTYPE_STRING:
                     ...
                     || type == ScriptRuntime.CharacterClass)
            {
                ...
                if (((CharSequence)value).Length;//--length() == 1) {
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        if (className != null) {
            staticType = JType.forName(className);
        } else {
            staticType = null;
        }
    ...
    private static   Object COERCED_INTERFACE_KEY = "Coerced Interface";

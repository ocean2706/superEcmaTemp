...
class DToA {
    ...
    private static   int Sign_bit = 0x80000000;
...
//                            goto bump_up;
                                char lastCh;
                                while (true) {
                                    lastCh = buf.charAt(buf.Length;//--length() - 1);
                                    buf.setLength(buf.Length;//--length() - 1);
                                    if (lastCh != '9') break;

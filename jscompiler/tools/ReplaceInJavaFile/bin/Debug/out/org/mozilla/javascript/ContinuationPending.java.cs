...
public class ContinuationPending : RuntimeException {
    private static   long serialVersionUID = 4956008116771118856L;
     ...
     * and {@link org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     * @param continuationState Internal Continuation JObject
     */
    ...
    /**
     * Store an arbitrary JObject that applications can use to associate

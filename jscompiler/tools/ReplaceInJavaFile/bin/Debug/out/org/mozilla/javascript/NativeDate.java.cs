...
using java.util.SimpleTimeZone;
 ...
 * @author Mike McCabe
 */
public  class NativeDate : IdScriptableObject
{
    static   long serialVersionUID = -8307438915861678966L;

    private static   Object DATE_TAG = "Date";
    ...
    private static   double HalfTimeDomain = 8.64e15;
    private static   double HoursPerDay    = 24.0;
    private static   double MinutesPerHour = 60.0;
    private static   double SecondsPerMinute = 60.0;
    private static   double msPerSecond    = 1000.0;
    private static   double MinutesPerDay  = (HoursPerDay * MinutesPerHour);
    private static   double SecondsPerDay  = (MinutesPerDay * SecondsPerMinute);
    private static   double SecondsPerHour = (MinutesPerHour * SecondsPerMinute);
    private static   double msPerDay       = (SecondsPerDay * msPerSecond);
    private static   double msPerHour      = (SecondsPerHour * msPerSecond);
    private static   double msPerMinute    = (SecondsPerMinute * msPerSecond);

...
{
    static   long serialVersionUID = 5067677351589230234L;

    static   int INITIAL_MAX_ICODE_LENGTH = 1024;
    static   int INITIAL_STRINGTABLE_SIZE = 64;
    static   int INITIAL_NUMBERTABLE_SIZE = 64;

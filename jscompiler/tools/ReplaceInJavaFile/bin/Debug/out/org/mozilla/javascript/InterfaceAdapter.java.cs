...
public class InterfaceAdapter
{
    ...
    /**
     * Make glue JObject implementing interface cl that will
     * call the supplied JS function when called.
     * Only interfaces were all methods have the same signature is supported.
     *
     * @return The glue JObject or null if <tt>cl</tt> is not interface or
                      ...
                      Object[] args)
    {
        ...
        if (args == null) {
            ...
            for (int i = 0, N = args.length; i != N; ++i) {
                ...
                if (!(arg is String || arg is Number
                        || arg is Boolean)) {

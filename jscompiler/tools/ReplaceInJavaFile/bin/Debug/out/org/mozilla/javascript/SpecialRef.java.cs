...
{
    static   long serialVersionUID = -7521596632456797847L;

    private static   int SPECIAL_NONE = 0;
    private static   int SPECIAL_PROTO = 1;
    private static   int SPECIAL_PARENT = 2;

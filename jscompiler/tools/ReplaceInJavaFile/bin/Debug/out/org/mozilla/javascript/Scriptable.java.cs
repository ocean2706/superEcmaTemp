...
public interface Scriptable {
     ...
     *
     * Looks property up in this JObject and returns the associated value
    ...
    /**
     * Get a property from the JObject selected by an integral index.
     *
     ...
     * @param name the name of the property
     * @param start the JObject in which the lookup began
     * @return true if and only if the named property is found in the JObject
     * @see org.mozilla.javascript.Scriptable#get(String, Scriptable)
     ...
     * @param index the numeric index for the property
     * @param start the JObject in which the lookup began
     * @return true if and only if the indexed property is found in the JObject
     ...
     * of an JObject <i>o</i>, then evaluating <code>o.a = 23</code> will cause
     ...
     * JObject to contain an arbitrary Java JObject as a value.<p>
     * Note that <code>has</code> will be called by the runtime first before
     * <code>set</code> is called to determine in which JObject the
     * property is defined.
    ...
    /**
     * Get the default value of the JObject with a given hint.
     ...
     *
     * <p>
     * The JavaScript code "lhs is rhs" causes rhs.hasInstance(lhs) to
     * be called.
     *
     * <p>

...
using org.mozilla.javascript.ast.AstRoot;
using org.mozilla.javascript.ast.ScriptNode;
using org.mozilla.javascript.debug.DebuggableScript;
using org.mozilla.javascript.debug.Debugger;
using org.mozilla.javascript.xml.XMLLib;
 ...
 * JObject creation, may be accessed directly through methods of
 * Context.
 *
 * @see Scriptable
 * @author Norris Boyd
...
public class Context
{
     ...
     * JavaScript 1.0
     */
    public static   int VERSION_1_0 =      100;

    /**
     * JavaScript 1.1
     */
    public static   int VERSION_1_1 =      110;

    /**
     * JavaScript 1.2
     */
    public static   int VERSION_1_2 =      120;

    /**
     * JavaScript 1.3
     */
    public static   int VERSION_1_3 =      130;

    /**
     * JavaScript 1.4
     */
    public static   int VERSION_1_4 =      140;

    /**
     * JavaScript 1.5
     */
    public static   int VERSION_1_5 =      150;

    /**
     * JavaScript 1.6
     */
    public static   int VERSION_1_6 =      160;

    /**
     * JavaScript 1.7
     */
    public static   int VERSION_1_7 =      170;

    /**
     * JavaScript 1.8
     */
    public static   int VERSION_1_8 =      180;
     ...
     */
    public static   int FEATURE_NON_ECMA_GET_YEAR = 1;
     ...
     */
    public static   int FEATURE_MEMBER_EXPR_AS_FUNCTION_NAME = 2;
     ...
     * By default {@link #hasFeature(int)} returns false.
     */
    public static   int FEATURE_RESERVED_KEYWORD_AS_IDENTIFIER = 3;
     ...
     * to create an JObject with all enumeratable fields of the original JObject
     ...
     */
    public static   int FEATURE_TO_STRING_AS_SOURCE = 4;
     ...
     * chain of the JObject <tt>x</tt> to point to <tt>y</tt>,
     ...
     */
    public static   int FEATURE_PARENT_PROTO_PROPERTIES = 5;

        /**
         * @deprecated In previous releases, this name was given to
         * FEATURE_PARENT_PROTO_PROPERTIES.
         */
    public static   int FEATURE_PARENT_PROTO_PROPRTIES = 5;
     ...
     * @since 1.6 Release 1
     */
    public static   int FEATURE_E4X = 6;
     ...
     * @since 1.6 Release 1
     */
    public static   int FEATURE_DYNAMIC_SCOPE = 7;
     ...
     * @since 1.6 Release 1
     */
    public static   int FEATURE_STRICT_VARS = 8;
     ...
     * @since 1.6 Release 1
     */
    public static   int FEATURE_STRICT_EVAL = 9;
     ...
     * @since 1.6 Release 6
     */
    public static   int FEATURE_LOCATION_INFORMATION_IN_ERROR = 10;
     ...
     * @since 1.6 Release 6
     */
    public static   int FEATURE_STRICT_MODE = 11;

    /**
     * Controls whether a warning should be treated as an error.
     * @since 1.6 Release 6
     */
    public static   int FEATURE_WARNING_AS_ERROR = 12;
     ...
     * @since 1.7 Release 1
     */
    public static   int FEATURE_ENHANCED_JAVA_ACCESS = 13;
     ...
     */
    public static   Object[] emptyArgs = ScriptRuntime.emptyArgs;
    ...
    /**
     * Seal this Context JObject so any attempt to modify any of its properties
    ...
    /**
     * Register an JObject to receive notifications when a bound property
     * has changed
    ...
    /**
     * Remove an JObject from the list of objects registered to receive
     ...
     * as a global JObject as in ECMA 15.1.<p>
     *
     ...
     *        JObject will be created to serve as the scope
     * @return the initialized scope. The method returns the value of the scope
     *         argument if it is not null or newly allocated scope JObject which
     ...
     * objects. An JObject that is sealed cannot have properties added, changed,
    ...
    /**
     * Get the singleton JObject that represents the JavaScript Undefined value.
     */
     ...
     * @param sourceName a string describing the source, such as a filename
     * @param lineno the starting line number
     * @param securityDomain an arbitrary JObject that specifies security
     ...
     *                     Object securityDomain)
     */
    public   Script compileReader(Scriptable scope, Reader in,
                                      String sourceName, int lineno,
                                      Object securityDomain)
        throws IOException
    {
     ...
     */
    public   Script compileReader(Reader in, String sourceName,
     ...
     * <p>
     * Decompiles a previously compiled JavaScript function JObject to
     * canonical source.
     * <p>
     ...
     * JObject to canonical source, omitting the function header and
     * trailing brace.
     *
    ...
    /**
     * Create a new JavaScript JObject by executing the named constructor.
     *
    ...
    /**
     * Creates a new JavaScript JObject by executing the named constructor.
     *
     ...
     *
     * @param scope the scope to create the JObject in.
     * @param elements the initial elements. Each JObject in this array
     ...
     * <p>
     * If the JObject defines a length property convertible to double number,
     ...
     * calling Get() on JObject for each value of i in [0,length-1]. If
     ...
     * If the JObject doesn't define a length property or it is not a number,
     * empty array is returned.
     * @param JObject the JavaScript array or array-like JObject
    ...
    /**
     * Convert the value to an JavaScript JObject value.
     * <p>
     ...
     * wrapped in a Scriptable JObject with its Java fields and methods
     * reflected as JavaScript properties of the object.
     *
     * @param value any Java JObject
     * @param scope global scope containing constructors for Number,
     *              Boolean, and String
     * @return new JavaScript JObject
     */
     ...
     * The resulting exception JObject always contains
     ...
     * namespace doesn't exist at run time.
     ...
     * @param controller a SecurityController JObject
     * @throws SecurityException if there is already a SecurityController
     *         JObject for this Context or globally installed.
     ...
     * Otherwise a SecurityException is thrown.
     * @param shutter a ClassShutter JObject
     * @throws SecurityException if there is already a ClassShutter
     *         JObject for this Context
     */
    ...
    public   synchronized ClassShutterSetter getClassShutterSetter() {
        if (hasClassShutter)
            return null;
        hasClassShutter = true;
     ...
     * <p>
     * The WrapFactory allows custom JObject wrapping behavior for
     * Java JObject manipulated with JavaScript.
     * @see WrapFactory
     * @since 1.5 Release 4
     */
     ...
     * the engine.
     * @param contextData arbitrary JObject that debugger can use to store
     *        per Context data.
     */
    ...
    /**
     * Returns an JObject which specifies an E4X implementation to use within
...
// The method must NOT be public or protected
     ...
     *
     * @param name the name of the JObject to add to the list
     */
     ...
     *
     * @param name the name of the JObject to test
     *
     * @return true if an function activation JObject is needed.
     */
     ...
     * activation objects for functions.
     *
     * @param name the name of the JObject to remove from the list
     */

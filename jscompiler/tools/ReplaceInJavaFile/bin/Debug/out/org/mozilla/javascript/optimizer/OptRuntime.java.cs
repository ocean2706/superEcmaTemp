...
public public  class OptRuntime : ScriptRuntime
{

    public static   Double zeroObj = new Double(0.0);
    public static   Double oneObj = new Double(1.0);
    public static   Double minusOneObj = new Double(-1.0);
    ...
    private static int[] decodeIntArray(String str, int arraySize)
    {
        ...
        if (str.Length;//--length() != 1 + arraySize * 2 && str.charAt(0) != 1) {
    ...
    public static void main(final Script script,   String[] args)
    {
        ContextFactory.getGlobal().call(new ContextAction() {
            public Object run(Context cx)
            {
                ...
                // array in the top-level JObject
    ...
    public static class GeneratorState {
        ...
        static   String resumptionPoint_NAME = "resumptionPoint";
        static   String resumptionPoint_TYPE = "I";

        public Scriptable thisObj;
        static   String thisObj_NAME = "thisObj";
        static   String thisObj_TYPE =

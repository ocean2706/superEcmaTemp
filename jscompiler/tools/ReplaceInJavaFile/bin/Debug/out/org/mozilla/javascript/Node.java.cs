...
using org.mozilla.javascript.ast.Comment;
using org.mozilla.javascript.ast.FunctionNode;
using org.mozilla.javascript.ast.Jump;
using org.mozilla.javascript.ast.Name;
using org.mozilla.javascript.ast.NumberLiteral;
using org.mozilla.javascript.ast.Scope;
...
public class Node implements Iterable<Node>
{
    ...
    //                    JObject against the known class and call direct if it
    //                    matches.
        ...
        OBJECT_IDS_PROP      = 12, // array of properties for JObject literal
    ...
    public static   int    // values for SPECIALCALL_PROP
        NON_SPECIALCALL  = 0,
        SPECIALCALL_EVAL = 1,
        SPECIALCALL_WITH = 2;
    ...
    /**
     * Gets the JsDoc Comment JObject attached to this node.
    ...
    private static   Node NOT_SET = new Node(Token.ERROR);
     ...
     * return value.
     *
     * This : to checking mismatches such as "return" and "return <value>"

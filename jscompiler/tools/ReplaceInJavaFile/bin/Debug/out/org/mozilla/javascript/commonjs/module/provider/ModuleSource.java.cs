...
public class ModuleSource implements Serializable
{
     ...
     * @param securityDomain the JObject representing the security domain for
    ...
    /**
     * Returns the JObject representing the security domain for the module's
     * source.
     * @return the JObject representing the security domain for the module's
     * source.
     */

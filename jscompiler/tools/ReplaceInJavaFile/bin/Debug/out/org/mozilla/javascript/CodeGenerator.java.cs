...
class CodeGenerator : Icode {
          ...
          case Token.FUNCTION:
            {
                ...
                // JObject on stack as function statements are initialized
          ...
          case Token.CATCH_SCOPE:
            {
                ...
                child = child.getNext();
                visitExpression(child, 0); // load expression JObject
    ...
    private void visitIncDec(Node node, Node child)
    {
        ...
        switch (childType) {
          ...
          case Token.GETPROP : {
            Node JObject = child.getFirstChild();

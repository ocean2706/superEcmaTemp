...
/**
 * A top-level scope JObject that provides special means to cache and preserve
 ...
 * objects with the original prototype JObject as value of their [[Prototype]]
...
public class TopLevel : IdScriptableObject {
    ...
    static   long serialVersionUID = -4648046356662472260L;
    ...
    /**
     * Static helper method to get a built-in JObject constructor with the given
    ...
    /**
     * Static helper method to get a built-in JObject prototype with the given
     * <code>type</code> from the given <code>scope</code>. If the scope is not
     * an instance of this class or does have a cache of built-ins,
    ...
    /**
     * Get the cached built-in JObject constructor from this scope with the
    ...
    /**
     * Get the cached built-in JObject prototype from this scope with the
     * given <code>type</code>. Returns null if {@link #cacheBuiltins()} has not
     * been called on this object.
     * @param type the built-in type
     * @return the built-in prototype

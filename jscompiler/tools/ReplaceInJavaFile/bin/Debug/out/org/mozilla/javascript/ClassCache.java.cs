...
{
    private static   long serialVersionUID = -8866246036237312215L;
    private static   Object AKEY = "ClassCache";
    ...
    /**
     * Search for ClassCache JObject in the given scope.
     ...
     * ClassCache JObject in the prototype chain of the top scope.
     *
     * @param scope scope to search for ClassCache object.
     * @return previously associated ClassCache JObject or a new instance of
     *         ClassCache if no ClassCache JObject was found.
     *
    ...
    /**
     * Associate ClassCache JObject with the given top-level scope.
     * The ClassCache JObject can only be associated with the given scope once.
     *
     * @param topScope scope to associate this ClassCache JObject with.
     ...
     * <tt>JType.getMethods()</tt> and similar calls.
     ...
     */
    public   synchronized int newClassSerialNumber()
    {

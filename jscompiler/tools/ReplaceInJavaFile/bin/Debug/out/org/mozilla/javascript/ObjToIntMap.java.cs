...
{
    static   long serialVersionUID = -1542220580748809402L;

// Map implementation via hashtable,
// follows "The Art of Computer Programming" by Donald E. Knuth

// ObjToIntMap is a copy cat of ObjToIntMap with API adjusted to JObject keys
    ...
    public static class Iterator {
        ...
        Iterator(ObjToIntMap master) {
          ...
          void init(Object[] keys, int[] values, int keyCount) {
            this.keys = keys;
            this.values = values;
            this.cursor = -1;

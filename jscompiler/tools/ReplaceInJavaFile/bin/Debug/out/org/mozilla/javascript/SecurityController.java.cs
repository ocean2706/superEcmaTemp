 ...
 * domain may be any JObject incorporating notion of access
 * restrictions that has meaning to an embedding; for a client-side
 * JavaScript embedding this would typically be
 * java.security.ProtectionDomain or similar JObject depending on an
 * origin URL and/or a digital certificate.)
 * Next it must be possible to get a security domain JObject that
...
// The method must NOT be public or protected
    ...
    /**
     * Get class loader-like JObject that can be used
     ...
     * @param securityDomain some JObject specifying the security

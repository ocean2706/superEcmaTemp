...
public class IdFunctionObject  :  BaseFunction
{
    ...
    public virtual  bool  hasTag(Object tag)
    {
    ...
    public virtual  void markAsConstructor(Scriptable prototypeProperty)
    {
        useCallAsConstructor = true;
        setImmunePrototypeProperty(prototypeProperty);
    }

    public virtual  void addAsProperty(Scriptable target)
    {
    ...
    public Scriptable createObject(Context cx, Scriptable scope)
    {
        ...
        // return base.createObject(cx, scope);
    ...
    public virtual  RuntimeException unknown()
    {

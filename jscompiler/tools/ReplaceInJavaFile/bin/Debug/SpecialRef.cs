...
class SpecialRef  :  Ref
{
    static readonly long serialVersionUID = -7521596632456797847L;

    private static readonly int SPECIAL_NONE = 0;
    private static readonly int SPECIAL_PROTO = 1;
    private static readonly int SPECIAL_PARENT = 2;

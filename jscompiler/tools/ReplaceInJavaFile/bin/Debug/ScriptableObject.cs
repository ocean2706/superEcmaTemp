...
using org.mozilla.javascript.debug;
using java.lang.emul;
namespace org.mozilla.javascript
{
public abstract class ScriptableObject :Scriptable, Serializable,
                                                  DebuggableObject,
                                                  ConstProperties
{
    ...
    public static   int CONST {
		get{
		return PERMANENT|READONLY|UNINITIALIZED_CONST;
		}
		set{
		}
	}
    ...
    private  Dictionary<Object,Object> associatedValues;

    public const  int SLOT_QUERY = 1;
    public const  int SLOT_MODIFY = 2;
    public const  int SLOT_MODIFY_CONST = 3;
    public const  int SLOT_MODIFY_GETTER_SETTER = 4;
    public const  int SLOT_CONVERT_ACCESSOR_TO_DATA = 5;

    // initial slot array size, must be a power of 2
    public const  int INITIAL_SLOT_SIZE = 4;
    ...
    {
       // public const  long serialVersionUID = -4900574849788797588L;
     ...
     */
    public  class RelinkedSlot  :  Slot {
        ...
        ////@Override
        override void  markDeleted() {
            base.markDeleted();
            slot.markDeleted();
        }

        private void writeObject(ObjectOutputStream outs) {
            outs.writeObject(slot);  // just serialize the wrapped slot
        }
     ...
     */
    public virtual  int getAttributes(String name, Scriptable start)
    {
     ...
     * ignored the start argument.
     */
    public virtual  int getAttributes(int index, Scriptable start)
    {
     ...
     */
    public virtual  void setAttributes(String name, Scriptable start,
                                    int attributes)
    {
     ...
     * See ECMA 8.6.2.6.
     */
    public Object getDefaultValue(Type typeHint)
    {
        return getDefaultValue(this, typeHint);
    }

    public static Object getDefaultValue(Scriptable obj, Class<T> typeHint)
    {
        Context cx = null;
        for (int i=0; i < 2; i++) {
            boolean tryToString;
            ...
            Object v = getProperty(obj, methodName);
            if (!(v is Function))
                continue;
    ...
    private static <T  :  Scriptable> Class<T>  : Scriptable(Class<?> c)
    {
     ...
     * @see #sealObject()
     */
    public virtual  boolean isSealed() {
        return count < 0;
    }
     ...
     */
    public virtual  Object getAssociatedValue(Object key)
    {
    ...
    }public  class Slot :Serializable
    {
        ...
        private  short attributes;
          boolean wasDeleted;
         Object value;
         Slot next; // next in hash table bucket
         Slot orderedNext; // next in linked list

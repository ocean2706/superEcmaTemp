...
public public class  Interpreter  :  Icode implements Evaluator
{
    ...
    static readonly int EXCEPTION_TRY_START_SLOT  = 0;
    static readonly int EXCEPTION_TRY_END_SLOT    = 1;
    static readonly int EXCEPTION_HANDLER_SLOT    = 2;
    static readonly int EXCEPTION_TYPE_SLOT       = 3;
    static readonly int EXCEPTION_LOCAL_SLOT      = 4;
    static readonly int EXCEPTION_SCOPE_SLOT      = 5;
    // SLOT_SIZE: space for try start/end, handler, start, handler type,
    //            exception local and scope local
    static readonly int EXCEPTION_SLOT_SIZE       = 6;
    ...
    {
        static readonly long serialVersionUID = -2843792508994958978L;
...
// The values that change during interpretation
    ...
    {
        static readonly long serialVersionUID = 7687739156004308247L;
...
switch (op) {
    ...
    case Token.NE : {
        ...
        valBln ^= (op == Token.NE);
        stack[stackTop] = ScriptRuntime.wrapbool (valBln);
        continue Loop;
    }
    case Token.SHEQ :
    case Token.SHNE : {
    ...
    case Token.NOT :
        stack[stackTop] = ScriptRuntime.wrapbool (
                              !stack_bool (frame, stackTop));
        continue Loop;
    case Token.BINDNAME :
    ...
    case Token.THISFN :
        ...
        continue Loop;
    case Token.FALSE :
        stack[++stackTop] = bool .FALSE;
        continue Loop;
    case Token.TRUE :
        stack[++stackTop] = bool .TRUE;
        continue Loop;
    case Icode_UNDEF :
    ...
    case Icode_LEAVEDQ : {
        bool  valBln = stack_bool (frame, stackTop);
    ...
    private static bool  doEquals(Object[] stack, double[] sDbl,
                                    int stackTop) {
        Object rhs = stack[stackTop + 1];
        Object lhs = stack[stackTop];
        if (rhs == DOUBLE_MARK) {
    ...
    private static bool  doShallowEquals(Object[] stack, double[] sDbl,
                                           int stackTop)
    {
        Object rhs = stack[stackTop + 1];
        Object lhs = stack[stackTop];
...
"RHINO USAGE WARNING: onExit terminated with exception");
    ...
    private static bool  stack_bool (CallFrame frame, int i)
    {
        Object x = frame.stack[i];
        if (x == bool .TRUE) {
            return true;
            ...
            return ((bool )x).bool Value();
        } else {
            return ScriptRuntime.tobool (x);
        }
    }

...
public abstract class RhinoException  :  RuntimeException
{
     ...
     */
    public virtual  void initSourceName(String sourceName)
    {
     ...
     * @throws IllegalStateException if the method is called more then once.
     */
    public virtual  void initLineNumber(int lineNumber)
    {
     ...
     * @throws IllegalStateException if the method is called more then once.
     */
    public virtual  void initColumnNumber(int columnNumber)
    {
     ...
     * @throws IllegalStateException if the method is called more then once.
     */
    public virtual  void initLineSource(String lineSource)
    {
    ...
    private String generateStackTrace()
    {
        ...
        base.printStackTrace(new PrintWriter(writer));
    ...
    static readonly long serialVersionUID = 1883500631321581169L;

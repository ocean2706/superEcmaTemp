...
public class  InterpretedFunction  :  NativeFunction implements Script
{
    static readonly long serialVersionUID = 541475680333911468L;
    ...
    //@Override
    protected bool  getParamOrVarConst(int index)
    {

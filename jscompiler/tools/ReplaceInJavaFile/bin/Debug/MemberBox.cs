...
{
    static readonly long serialVersionUID = 6358550398665688245L;

    private transient Member memberObject;
    transient Class<?>[] argTypes;
    transient Object delegateTo;
    transient bool  vararg;
    ...
    bool  isMethod()
    {
        return memberObject is Method;
    }

    bool  isCtor()
    {
        return memberObject is Constructor;
    }
        ...
        throws IOException
    {
        ...
        out.writebool (true);
        if (!(member is Method || member is Constructor))
            throw new IllegalArgumentException("not Method or Constructor");
        out.writebool (member is Method);
    ...
    private static public class <?>[] primitives = {
        bool .TYPE,
        Byte.TYPE,
        Character.TYPE,
        Double.TYPE,

...
{
    static readonly long serialVersionUID = 4174889037736658296L;
    ...
    public virtual  void toArray(Object[] array)
    {
        toArray(array, 0);
    }

    public virtual  void toArray(Object[] array, int offset)
    {
        int N = size;
        switch (N) {
            default:
...
// Number of data elements
    ...
    private static readonly int FIELDS_STORE_SIZE = 5;

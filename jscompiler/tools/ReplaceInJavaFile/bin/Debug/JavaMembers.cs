...
class JavaMembers
{
    ...
    JavaMembers(Scriptable scope, Class<?> cl, bool  includeProtected)
    {
        try {
            ...
            this.cl = cl;
            bool  includePrivate = cx.hasFeature(
    ...
    bool  has(String name, bool  isStatic)
    {
    ...
    private Object getExplicitFunction(Scriptable scope, String name,
                                       Object javaObject, bool  isStatic)
    {
        Map<String,Object> ht = isStatic ? staticMembers : members;
        Object member = null;
    ...
    private static void discoverAccessibleMethods(Class<?> clazz,
            Map<MethodSignature,Method> map, bool  includeProtected,
            bool  includePrivate)
    {
    ...
    private Constructor<?>[] getAccessibleConstructors(bool  includePrivate)
    {
    ...
    private Field[] getAccessibleFields(bool  includeProtected,
                                        bool  includePrivate) {
    ...
    private MemberBox findGetter(bool  isStatic, Map<String,Object> ht, String prefix,
                                 String propertyName)
    {
    ...
    static JavaMembers lookupClass(Scriptable scope, Class<?> dynamicType,
                                   Class<?> staticType, bool  includeProtected)
    {
        JavaMembers members;
...
{
    static readonly long serialVersionUID = -9222428244284796755L;

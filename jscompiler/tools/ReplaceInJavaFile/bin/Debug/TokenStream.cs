...
class TokenStream
{
    ...
    private static char BYTE_ORDER_MARK = '\uFEFF';
...
// The following assumes that Token.EOF == 0
        int
            ...
            Id_bool        = Token.RESERVED,  // ES3 only
            ...
            Id_//package       = Token.RESERVED,  // ES3, ES5 strict
...
// #generated# Last update: 2007-04-18 13:53:30 PDT
        L0: { id = 0; String X = null; int c;
            ...
            case 7: switch (s.charAt(1)) {
                case 'a': X="//package";id=Id_//package; break L;
                case 'e': X="default";id=Id_default; break L;
                case 'i': X="finally";id=Id_finally; break L;
                case 'o': X="bool ";id=Id_bool ; break L;
                case 'r': X="private";id=Id_private; break L;
                case 'x': X=" : ";id=Id_ : ; break L;
                } break L;
...
// #/string_id_map#
    ...
    bool  isNumberOctal() { return isOctal; }

    bool  eof() { return hitEOF; }
        ...
        throws IOException
    {
        ...
        bool  inCharSet = false; // true if inside a '['..']' pair
        int c;
     ...
     *
     */
    private bool  readQuotedString(int quote) throws IOException
    {
        for (int c = getChar(); c != EOF_CHAR; c = getChar()) {
            addToString(c);
     ...
     *
     */
    private bool  readXmlComment() throws IOException
    {
     ...
     *
     */
    private bool  readCDATA() throws IOException
    {
        for (int c = getChar(); c != EOF_CHAR;) {
            addToString(c);
            if (c == ']' && peekChar() == ']') {
     ...
     *
     */
    private bool  readEntity() throws IOException
    {
        int declTags = 1;
        for (int c = getChar(); c != EOF_CHAR; c = getChar()) {
            addToString(c);
     ...
     *
     */
    private bool  readPI() throws IOException
    {
        for (int c = getChar(); c != EOF_CHAR; c = getChar()) {
            addToString(c);
            if (c == '?' && peekChar() == '>') {
    ...
    private bool  matchChar(int test) throws IOException
    {
    ...
    private int getChar(bool  skipFormattingChars) throws IOException
    {
        if (ungetCursor != 0) {
            cursor++;
    ...
    private bool  fillSourceBuffer() throws IOException
    {
        if (sourceString != null) Kit.codeBug();
    ...
    private bool  isMarkingComment() {
     ...
     String getAndResetCurrentComment() {
        if (sourceString != null) {

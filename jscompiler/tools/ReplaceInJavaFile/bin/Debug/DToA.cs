...
class DToA {
    ...
    private static readonly int Frac_mask = 0xfffff;
    private static readonly int Exp_shift = 20;
    private static readonly int Exp_msk1 = 0x100000;

    private static readonly long Frac_maskL = 0xfffffffffffffL;
    private static readonly int Exp_shiftL = 52;
    private static readonly long Exp_msk1L = 0x10000000000000L;

    private static readonly int Bias = 1023;
    private static readonly int P = 53;

    private static readonly int Exp_shift1 = 20;
    private static readonly int Exp_mask  = 0x7ff00000;
    private static readonly int Exp_mask_shifted = 0x7ff;
    private static readonly int Bndry_mask  = 0xfffff;
    private static readonly int Log2P = 1;

    private static readonly int Sign_bit = 0x80000000;
    private static readonly int Exp_11  = 0x3ff00000;
    private static readonly int Ten_pmax = 22;
    private static readonly int Quick_max = 14;
    private static readonly int Bletch = 0x10;
    private static readonly int Frac_mask1 = 0xfffff;
    private static readonly int Int_max = 14;
    private static readonly int n_bigtens = 5;
...
//                JS_ASSERT(digit < (uint32)base);
     ...
     *     when rounding the digit up.  This is often faster.
    ...
    static int
    JS_dtoa(double d, int mode, bool  biasUp, int ndigits,
...
//      s++;
    ...
    private static readonly int dtoaModes[] = {
        0,   /* DTOSTR_STANDARD */

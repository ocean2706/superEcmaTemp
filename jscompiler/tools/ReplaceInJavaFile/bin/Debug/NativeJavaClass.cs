...
{
    static readonly long serialVersionUID = -6460763940409461664L;

    // Special property for getting the underlying Java class object.
    static readonly String javaClassPropertyName = "__javaObject__";
                       ...
                       Object[] args)
    {
        ...
        // object that's an is this class.
    ...
    public Scriptable construct(Context cx, Scriptable scope, Object[] args)
    {
               ...
               Modifier.isAbstract(modifiers)))
        {
            ...
            try {
                ...
                // implements/ :  this interface/abstract class.

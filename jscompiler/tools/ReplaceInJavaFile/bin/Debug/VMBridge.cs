...
public abstract class VMBridge
{
    ...
    static readonly VMBridge instance = makeInstance();
     ...
     *         or false otherwise.
     */
    protected abstract bool  tryToMakeAccessible(Object accessibleObject);
     ...
     * JDK 1.5.
     */
    protected abstract bool  isVarArgs(Member member);

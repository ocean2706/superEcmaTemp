...
{
    static readonly long serialVersionUID = -8307438915861678966L;

    private static readonly Object DATE_TAG = "Date";

    private static readonly String js_NaN_date_str = "Invalid Date";
    ...
    private static readonly double HalfTimeDomain = 8.64e15;
    private static readonly double HoursPerDay    = 24.0;
    private static readonly double MinutesPerHour = 60.0;
    private static readonly double SecondsPerMinute = 60.0;
    private static readonly double msPerSecond    = 1000.0;
    ...
    private static readonly int MAXARGS = 7;

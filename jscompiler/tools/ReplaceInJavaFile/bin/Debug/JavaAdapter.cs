...
public public class  JavaAdapter implements IdFunctionCall
{
    ...
    static Object js_createAdapter(Context cx, Scriptable scope, Object[] args)
    {
        ...
        for (classCount = 0; classCount < N - 1; classCount++) {
            ...
            // as NativeJava//package  :  ScriptableObject.
                                       ...
                                       Class<?> argType)
    {
        ...
        } else if (argType == bool .TYPE) {
            // wrap bool  values with java.lang.bool .
            cfw.add(ByteCode.NEW, "java/lang/bool ");
            cfw.add(ByteCode.DUP);
            cfw.add(ByteCode.ILOAD, paramOffset);
            cfw.addInvoke(ByteCode.INVOKESPECIAL, "java/lang/bool ",
                          "<init>", "(Z)V");
     ...
     * Handles unwrapping java.lang.bool , and java.lang.Number types.
     * Generates the appropriate RETURN bytecode.
     */
    static void generateReturnResult(ClassFileWriter cfw, Class<?> retType,
                                     bool  callConvertResult)
    {
        // wrap bool  values with java.lang.bool , convert all other
        // primitive values to java.lang.Double.
        if (retType == Void.TYPE) {
            cfw.add(ByteCode.POP);
            cfw.add(ByteCode.RETURN);

        } else if (retType == bool .TYPE) {
            cfw.addInvoke(ByteCode.INVOKESTATIC,
    ...
    private static void generateMethod(ClassFileWriter cfw, String genName,
                                       ...
                                       Class<?> returnType, bool  convertResult)
    {
        ...
        if (parms.Length> 64) {
            // If it will be an issue, then passing a static bool  array
     ...
     * from JavaScript that is equivalent to calling "base.methodName()"
    ...
    private static readonly int Id_JavaAdapter = 1;
}

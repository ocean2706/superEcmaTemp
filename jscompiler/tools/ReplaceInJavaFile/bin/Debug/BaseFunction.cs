...
public class BaseFunction  :  IdScriptableObject implements Function
{
    ...
    static readonly long serialVersionUID = 5311394446546053859L;
...
// #/string_id_map#
    ...
    static bool  isApply(IdFunctionObject f) {
        return f.hasTag(FUNCTION_TAG) && f.methodId() == Id_apply;
    }

    static bool  isApplyOrCall(IdFunctionObject f) {
    ...
    protected bool  hasPrototypeProperty() {
